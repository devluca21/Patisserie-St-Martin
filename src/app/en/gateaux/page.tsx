...
export const metadata: Metadata = {
  title: 'Our Cakes | Patisserie St. Martin',
  description: 'Discover our wedding cakes, classic cakes and custom cakes. Unique artisan creations for your special occasions.',
};
      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 py-6 sm:py-8 lg:py-12">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg md:text-xl text-patisserie-secondary max-w-3xl mx-auto px-2">
            Unique artisan creations for your special occasions
          </p>
        </div>
